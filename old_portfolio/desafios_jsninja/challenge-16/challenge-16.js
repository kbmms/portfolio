...
for(var i = 0; i < marcel.length; i++){
   console.log(marcel.charAt(i) + " é a " +(i+1) + "ª letra do meu nome.")
}
...
var fullName = "marcel-correia-santos";
...
*/
console.log( '\nMeus amigos:' );
var friends = ['Marcel', 'Marcos', 'Paulo', 'Roberto'];
...
*/
console.log( '\nEra "Roberto", agora é:' );
console.log('Roberto'.replace('to','a'))
